...
def show_member(id):
    ...
    attendances_found = sorted(attendance_repository.select_by_member(member_found), key = lambda attendance: (attendance.gym_class.date, attendance.gym_class.time))
