...
def show_member(id):
    ...
    return render_template('members/show.html', title=f"Member #{member_found.id} - {member_found.first_name} {member_found.last_name}", member=member_found)
...
@member_blueprint.route('/members/delete', methods = ['POST'])
